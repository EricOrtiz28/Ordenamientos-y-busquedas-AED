 ...
 * @author hp
 */
public class FrmLinkedListBicycle extends javax.swing.JFrame {

    private final DefaultListModel<String> modeloList1 = new DefaultListModel<>();
    private final DefaultListModel<String> modeloList2 = new DefaultListModel<>();
    private ListaBicicletas lista;
    private final String CADENA_VACIA="";
    
    public FrmLinkedListBicycle() {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblNomPropietario.setText("Ingresa nombre del propietario:");
...
//            evt.consume();
    ...
    private void printResult(){
        ...
        modeloList2.add(0, lista.toString());
    }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        printResult(); // Para actualizar el valor
        txtValor.requestFocus();
    }//GEN-LAST:event_btnEliminarActionPerformed
    private void Registrar(){
        String nomPropietario = txtValor.getText().trim();

        if (txtValor.getText().trim().isEmpty() ) return;        
        
        if (rbUnicos.isSelected() && !modeloList1.contains(nomPropietario)) {
            modeloList1.addElement(nomPropietario);
        }
        ...
        Bicicleta nuevaBicicleta = new Bicicleta(nomPropietario);
        lista.addLast(nuevaBicicleta);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmLinkedListBicycle.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmLinkedListBicycle().setVisible(true);
            }
        });
    }
